		...
		<>
			...
			<div className="container absolute inset-0 flex flex-col items-center justify-start p-16 gap-xl">
				...
				<div className="flex flex-col md:flex-row gap-md">
					<Link href={"https://shipkit.io"} className={buttonVariants({ variant: "outline", size: "lg" })}>Learn More</Link>
					<Link href={"https://github.com/shipkit-io/bones"} className={buttonVariants({ variant: "default", size: "lg" })}>Get Started</Link>
				</div>
			</div>
		</>
	);
